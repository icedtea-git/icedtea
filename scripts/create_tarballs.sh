...
if test "${CTYPE}" = "xz"; then
    git config tar.tar.xz.command "xz -c"
elif test "${CTYPE}" = "bz2"; then
...
# Local Variables:
# compile-command: "shellcheck create_tarballs.sh"
# fill-column: 80
