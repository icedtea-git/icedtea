...
do
	wget -O $repos.tar.gz https://icedtea.classpath.org/hg/icedtea7-forest/$repos/archive/tip.tar.gz
done
wget -O openjdk.tar.gz https://icedtea.classpath.org/hg/icedtea7-forest/archive/tip.tar.gz
