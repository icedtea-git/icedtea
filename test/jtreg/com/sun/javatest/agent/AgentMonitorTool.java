...
public class AgentMonitorTool extends Tool
{
    ...
    */
     ...
     */
    /*OLD
    public static AgentMonitorTool restore(Desktop desktop, Map m) {
        AgentMonitorManager amm = (AgentMonitorManager) (desktop.getToolManager(AgentMonitorManager.class));
        AgentMonitorTool t = amm.getTool();
        t.restore0(m);
        return t;
    */
        ...
        implements ItemListener, ActiveAgentPool.Observer
    {
        AgentPoolSubpanel() {
            ...
            // Note there is a slight synchronization window bewteen the call of
