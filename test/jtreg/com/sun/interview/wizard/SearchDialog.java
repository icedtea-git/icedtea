...
class SearchDialog extends JDialog
{
    static SearchDialog create(Component parent, Interview i) {
        ...
        if (d != null)
            return new SearchDialog(d, i);
        else {
            Frame f = (Frame)(SwingUtilities.getAncestorOfClass(Frame.class, parent));
            return new SearchDialog(f, i);
        }
    }

    SearchDialog(Frame parent, Interview i) {
        super(parent);
        init(parent, i);
    }

    SearchDialog(Dialog parent, Interview i) {
        super(parent);
        init(parent, i);
    }

    private void init(Component parent, Interview i) {
        interview = i;
